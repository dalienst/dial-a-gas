    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', cloudinary.models.CloudinaryField(blank=True, max_length=255, null=True, verbose_name='buyer_images')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', cloudinary.models.CloudinaryField(blank=True, max_length=255, null=True, verbose_name='vendor_images')),
                ('phone_number', models.BigIntegerField(blank=True, null=True)),
                ('shop_location', models.CharField(blank=True, max_length=1000, null=True)),
            ],
            options={
                'abstract': False,
            },
